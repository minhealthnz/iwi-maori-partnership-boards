...
Two separate geometry files are also provided to enable geospatial presentation of IMPB boundaries (`impb_geometry_2026.geojson` and `impb_geom_water.zip`). These files are zipped due to size restraints.
